---
title: "Lecture 11: PY 0782 - Advanced Quantitative Research Methods"
...
Hurray, I solved something, remember those overflowing code bits, meet ['xaringan'](https://github.com/yihui/xaringan)
...
knitr::include_graphics("http://rpsychologist.com/img/r-reference-lmer/2lvl.png")
```
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("http://rpsychologist.com/img/r-reference-lmer/3lvl.png")
```
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("http://rpsychologist.com/img/r-reference-lmer/3lvl-crossed.png")
```
...
* Exercises (more in-class). Additional exercises, perhaps interactive. Might become *mandatory*.
* Room blocked for exercises. Perhaps teaching assistant support.
* ...
...
Questions on assignment via discussion board. (Unavailable Dec. 22nd to Jan. 5th)

```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("http://s2.quickmeme.com/img/57/572104c5c7a5a5df4a63e344671d7c2e8fe7600e5aabfd02d68efa8033db4bf9.jpg")
```
