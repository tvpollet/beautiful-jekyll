...
You can post questions via blackboard (BB). Book an appointment with me for substantive issues if unresolved via BB ([check availability](https://tvpollet.github.io/calendar/)).

Questions on assignment via discussion board. (Unavailable Dec. 18th to Jan. 6th). 

Will not answer any questions post Jan 27th.
