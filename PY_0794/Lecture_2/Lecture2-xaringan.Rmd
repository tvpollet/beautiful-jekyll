...
```{r, fig.align='center' ,fig.height=4, fig.width=4, tidy.opts=list(width.cutoff=5)}
...
```{r, warning=F, message=F, fig.align="center",fig.height=4.5, fig.width=6}
...
```{r, warning=F, message=F, fig.height=1.9, fig.width=3, tidy.opts=list(width.cutoff=35)}
...
```{r, warning=F, message=F, fig.height=3.6, fig.width=5, fig.pos="center"}
...
```{r, warning=F, message=F, tidy=TRUE, fig.height=4, fig.width=4, tidy.opts=list(width.cutoff=12)}
...
```{r, tidy=TRUE, fig.height=3, fig.width=4, tidy.opts=list(width.cutoff=35), warning=F, message=F}
