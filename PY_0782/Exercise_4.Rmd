...
**Sample write up**: Years since Ph.D. and monthly salary were positively and moderately related ($r_s$_= .47, _p_<.0001).
...
Note that in the final model years since Ph.D. is no longer statistically significant. It is important to note that we have not yet looked into the assumptions or 
...
summarytools::dfSummary(data_credit)
```
...
ROC curves are supercool and they are a tool used across a broad range of sciences. You can read up on them in the Agresti reference from the reading list. You can also read more in the reading lists or [here](https://onlinecourses.science.psu.edu/stat504/node/163). Anyway, have a look what's out there and try to have a go at making one yourself.
